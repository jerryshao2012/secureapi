function AccountValidator() {
    ...
    this.formFields = [$('#user-tf'), $('#email-tf'), $('#pass-tf')];
    this.controlGroups = [$('#user-cg'), $('#email-cg'), $('#pass-cg')];
...
AccountValidator.prototype.validateForm = function () {
    ...
    if (this.formFields[0].attr('disabled') !== 'disabled' && this.validateName(this.formFields[0].val()) === false) {
        this.controlGroups[0].addClass('error');
